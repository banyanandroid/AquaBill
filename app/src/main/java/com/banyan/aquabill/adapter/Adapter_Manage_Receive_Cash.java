...
public class Adapter_Manage_Receive_Cash extends BaseAdapter {
    ...
    public Adapter_Manage_Receive_Cash(Activity a, ArrayList<HashMap<String, String>> d) {
        activity = a;
        data=d;
    ...
    public long getItemId(int position) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            date.setText(result.get(Activity_Manage_Received_Cash.TAG_DATE));
            time.setText(result.get(Activity_Manage_Received_Cash.TAG_TIME));
            invoice_no.setText(result.get(Activity_Manage_Received_Cash.TAG_RECEIPT_NO));
            customer.setText(result.get(Activity_Manage_Received_Cash.TAG_CUSTOMER_NAME));
            dealer.setText(result.get(Activity_Manage_Received_Cash.TAG_DEALER_NAME));
            payment_type.setText(result.get(Activity_Manage_Received_Cash.TAG_PAYMENT_TYPE));
            amt.setText(result.get(Activity_Manage_Received_Cash.TAG_RECEIVED_AMT));
            refno.setText(result.get(Activity_Manage_Received_Cash.TAG_CHEQUE_NO));
            bank.setText(result.get(Activity_Manage_Received_Cash.TAG_BANK_NAME));
