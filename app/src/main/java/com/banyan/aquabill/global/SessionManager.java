...
import com.banyan.aquabill.activity.Activity_Login;
...
public class SessionManager {
	 ...
	 * */
	public void createLoginSession(String dealer_id, String usertype, String dealer_code, String dealer_name, String email_id
			, String mobile_no, String language){
		// Storing login value as TRUE
		editor.putBoolean(IS_LOGIN, true);

		// Storing name in pref
		editor.putString(KEY_DEALER_ID, dealer_id);
		editor.putString(KEY_USER_TYPE, usertype);
		editor.putString(KEY_DEALER_CODE, dealer_code);
		editor.putString(KEY_DEALER_NAME, dealer_name);
	...
	public HashMap<String, String> getUserDetails(){
		...
		user.put(KEY_DEALER_ID, pref.getString(KEY_DEALER_ID, null));
