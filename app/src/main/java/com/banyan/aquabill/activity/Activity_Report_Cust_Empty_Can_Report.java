...
import com.banyan.aquabill.adapter.Adapter_Report_Customer_Empty_Can;
...
public class Activity_Report_Cust_Empty_Can_Report extends AppCompatActivity {

    String TAG = "Customer Empty Can";
    ...
    static ArrayList<HashMap<String, String>> report_cust_empt_can_list;
    ...
    public static final String TAG_DELIVERED_QTY = "delivered_qty";
    public static final String TAG_RECEIVED_QTY = "received_qty";
    public static final String TAG_OPENING = "opening";
    public static final String TAG_CLOSING = "closing";

    private Adapter_Report_Customer_Empty_Can adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_report_customer_empty_can);

        mToolbar = (Toolbar) findViewById(R.id.toolbar);
        parent_view = findViewById(android.R.id.content);

        setSupportActionBar(mToolbar);
        getSupportActionBar().setTitle("Customer Empty Can Report");
        ...
        edt_from_date = (EditText) findViewById(R.id.report_cus_empty_can_edt_from_Date);
        edt_to_date = (EditText) findViewById(R.id.report_cus_empty_can_edt_to_Date);

        spn_customer = (SearchableSpinner) findViewById(R.id.report_cus_empty_can_spn_customer);
        spn_product = (SearchableSpinner) findViewById(R.id.report_cus_empty_can_spn_mode);

        btn_get_data = (Button) findViewById(R.id.report_cus_empty_can_btn_get_Data);

        list_report = (ListView)  findViewById(R.id.report_cus_empty_can_listview);
        ...
        report_cust_empt_can_list = new ArrayList<HashMap<String, String>>();
        ...
        spn_customer.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                try {
                    dialog = new SpotsDialog(Activity_Report_Cust_Empty_Can_Report.this);
                    dialog.show();
                    queue = Volley.newRequestQueue(Activity_Report_Cust_Empty_Can_Report.this);
                    Action_Get_Product();
                }catch (Exception e) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        for (int i = 0; arr.length() > i; i++) {
                            ...
                            try {
                                spn_customer
                                        .setAdapter(new ArrayAdapter<String>(Activity_Report_Cust_Empty_Can_Report.this,
...
// Launch Date Picker Dialog
        DatePickerDialog dpd = new DatePickerDialog(
                Activity_Report_Cust_Empty_Can_Report.this,
...
// Launch Date Picker Dialog
    ...
    public void Action_Get_Record() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST,
                Appconfig.url_customer_emptycan, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        report_cust_empt_can_list.clear();
                        ...
                        for (int i = 0; arr.length() > i; i++) {
                            ...
                            String prod_name = obj1.getString(TAG_PRODUCT_NAME);
                            String receipt_no = obj1.getString(TAG_RECEIPT_NO);
                            String delivered_qty = obj1.getString(TAG_DELIVERED_QTY);
                            String received_qty = obj1.getString(TAG_RECEIVED_QTY);
                            String opening = obj1.getString(TAG_OPENING);
                            String closing = obj1.getString(TAG_CLOSING);
                            ...
                            map.put(TAG_PRODUCT_NAME, prod_name);
                            map.put(TAG_RECEIPT_NO, receipt_no);
                            map.put(TAG_DELIVERED_QTY, delivered_qty);
                            map.put(TAG_RECEIVED_QTY, received_qty);
                            map.put(TAG_OPENING, opening);
                            map.put(TAG_CLOSING, closing);

                            report_cust_empt_can_list.add(map);

                            adapter = new Adapter_Report_Customer_Empty_Can(Activity_Report_Cust_Empty_Can_Report.this,
                                    report_cust_empt_can_list);
