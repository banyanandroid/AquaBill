...
public class Activity_Add_Raw_Mat_Invoice extends AppCompatActivity {
    ...
    ArrayList<String> Arraylist_raw_mat_id = null;
    ArrayList<String> Arraylist_raw_mat_name = null;
    ArrayList<String> Arraylist_raw_mat_stock = null;
    ArrayList<String> Arraylist_raw_mat_price = null;
    ArrayList<String> Arraylist_raw_mat_tax = null;
    ArrayList<String> Arraylist_raw_mat_tax_price = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_raw_mat_invoice);

        mToolbar = (Toolbar) findViewById(R.id.toolbar);
        parent_view = findViewById(android.R.id.content);

        setSupportActionBar(mToolbar);
        getSupportActionBar().setTitle("Add Raw Material Invoice");
        ...
        Arraylist_raw_mat_id = new ArrayList<String>();
        Arraylist_raw_mat_name = new ArrayList<String>();
        Arraylist_raw_mat_stock = new ArrayList<String>();
        Arraylist_raw_mat_price = new ArrayList<String>();
        Arraylist_raw_mat_tax = new ArrayList<String>();
        Arraylist_raw_mat_tax_price = new ArrayList<String>();
        ...
        spn_customer.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                try {
                    dialog = new SpotsDialog(Activity_Add_Raw_Mat_Invoice.this);
                    dialog.show();
                    queue = Volley.newRequestQueue(Activity_Add_Raw_Mat_Invoice.this);
                    Action_Get_Product();
                }catch (Exception e) {
        ...
        spn_product.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                t1 = (TextView) view;
                String str_state = t1.getText().toString();
                str_product_id = Arraylist_raw_mat_id.get(position);
                str_product = Arraylist_raw_mat_name.get(position);
                str_product_stock = Arraylist_raw_mat_stock.get(position);
                str_product_price = Arraylist_raw_mat_price.get(position);
                str_product_gst = Arraylist_raw_mat_tax.get(position);
                str_product_tax_price = Arraylist_raw_mat_tax_price.get(position);
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        for (int i = 0; arr.length() > i; i++) {
                            ...
                            try {
                                spn_customer
                                        .setAdapter(new ArrayAdapter<String>(Activity_Add_Raw_Mat_Invoice.this,
    ...
    public void Action_Get_Product() {
        ...
        System.out.println("CAME 1");
        final StringRequest request = new StringRequest(Request.Method.POST,
                Appconfig.url_invoice_raw_mat_list, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        Arraylist_raw_mat_id.clear();
                        Arraylist_raw_mat_name.clear();
                        Arraylist_raw_mat_stock.clear();
                        Arraylist_raw_mat_price.clear();
                        Arraylist_raw_mat_tax.clear();
                        Arraylist_raw_mat_tax_price.clear();

                        for (int i = 0; arr.length() > i; i++) {
                            JSONObject obj1 = arr.getJSONObject(i);

                            String prod_id = obj1.getString("rawmaterial_id");
                            String prod_name = obj1.getString("rawmaterial_name");
                            String stock = obj1.getString("stock");
                            String prod_price = obj1.getString("price");
                            String gst_percent = obj1.getString("tax");
                            String tax_price = obj1.getString("taxprice");

                            Arraylist_raw_mat_id.add(prod_id);
                            Arraylist_raw_mat_name.add(prod_name);
                            Arraylist_raw_mat_stock.add(stock);
                            Arraylist_raw_mat_price.add(prod_price);
                            Arraylist_raw_mat_tax.add(gst_percent);
                            Arraylist_raw_mat_tax_price.add(tax_price);

                            try {
                                spn_product
                                        .setAdapter(new ArrayAdapter<String>(Activity_Add_Raw_Mat_Invoice.this,
                                                android.R.layout.simple_spinner_dropdown_item,
                                                Arraylist_raw_mat_name));
                        ...
                        Snackbar.make(parent_view, "No Raw Material Data Found", Snackbar.LENGTH_SHORT).show();
    ...
    private void Action_Add_Invoice() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST,
                Appconfig.url_add_raw_mat_invoice, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        new AlertDialog.Builder(Activity_Add_Raw_Mat_Invoice.this)
                                .setTitle("Aqua Bill")
                                ...
                                .setPositiveButton("Ok",
                                        new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface alert_dialog,
                                                ...
                                                Intent i = new Intent(Activity_Add_Raw_Mat_Invoice.this, Activity_Manage_Raw_MaterialInvoice.class);
                                                startActivity(i);
                                                finish();
