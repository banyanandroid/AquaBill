...
public class Activity_Manage_Invoice extends AppCompatActivity implements SheetLayout.OnFabAnimationEndListener, SwipeRefreshLayout.OnRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.post(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        try {
                                            queue = Volley.newRequestQueue(Activity_Manage_Invoice.this);
                                            GetInvoiceList();
    ...
    public void onFabAnimationEnd() {
        Intent intent = new Intent(Activity_Manage_Invoice.this, Activity_Add_Invoice.class);
    ...
    public void GetInvoiceList() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST,
                Appconfig.url_invoice_list, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        for (int i = 0; arr.length() > i; i++) {
                            ...
                            adapter = new Adapter_Manage_Invoice(Activity_Manage_Invoice.this,
                                    Invoice_list);
    ...
    private void Func_Alert_dialog(int position) {
        ...
        LayoutInflater li = LayoutInflater.from(Activity_Manage_Invoice.this);
        View promptsView = li.inflate(R.layout.alert_invoice_preview, null);

        AlertDialog alert_dialog = new AlertDialog.Builder(Activity_Manage_Invoice.this)
                .setView(promptsView)
                .setTitle("Aqua Bill")
