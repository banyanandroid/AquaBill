...
import com.banyan.aquabill.adapter.Adapter_Manage_Receive_Can;
...
public class Activity_Manage_Received_Can extends AppCompatActivity implements SheetLayout.OnFabAnimationEndListener, SwipeRefreshLayout.OnRefreshListener{
    ...
    private Adapter_Manage_Receive_Can adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Manage Received Can");
        ...
        swipeRefreshLayout.post(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        try {
                                            queue = Volley.newRequestQueue(Activity_Manage_Received_Can.this);
                                            GetInvoiceList();
    ...
    public void onFabAnimationEnd() {
        Intent intent = new Intent(Activity_Manage_Received_Can.this, Activity_Add_Received_Can.class);
    ...
    public void GetInvoiceList() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST,
                Appconfig.url_receive_can_list, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        for (int i = 0; arr.length() > i; i++) {
                            ...
                            adapter = new Adapter_Manage_Receive_Can(Activity_Manage_Received_Can.this,
                                    received_cash_list);
